...
# or "Examine the pairs() plot to diagnose sampling problems"
# appear, then check the traceplots/chains as saved a couple of lines below in "Chains_..._...pdf"
# and the correlations in "..._pairs_...png"
